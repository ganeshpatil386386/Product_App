...
export const Hero = () => {
    ...
    className="relative
        ...
        <h1 className="mt-10 font-palanquin text-8xl 
            max-sm:text-[72px] max-sm:leaging-[82] font-bold ">
            ...
            <p className="font-montserrat text-slate-gray text-lg leading-9 mt-6 mb-14 sm:max-w-sm">
        ...
        -bottom-[5%] sm:left-[10%] max-sm:px-6">
            {shoes.map((shoe, index) => (
                <div key={shoe}>
                    <ShoeCard 
                      imgURL={shoe}
                      changeBigShoeImage= {(shoe) => setBigShoeImg
                        (shoe)}
